  ...
  render() {
    ...
    return (
      <div className="ListWarnings">
        ...
        <p>⚠️ Cette liste émane d'un parti politique du {Math.floor(list.info.year_established/100)}e siècle. Il a été créé en {list.info.year_established}. A ce moment, il n'y avait pas d'Internet. Ce n'est donc pas dans leur ADN de partager l'information et de permettre à tout le monde de collaborer.</p>
        }
